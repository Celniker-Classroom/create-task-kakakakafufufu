...
document.getElementById("submit").addEventListener("click", function(){
    document.getElementById("remind").textContent = "Choose all the things you like:"
    let checkboxes = [
...
function showResult(List,sum){
    ...
    document.getElementById('percent'+(i+1)).textContent = "Option "+ (i+1) +": "+List[i]+" votes"+" / "+percentList[i]+"%"
    }
